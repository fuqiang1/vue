<template>
  ...
  <div>
    <div class="agreement-area row" v-show="contractType === 1 || contractType === 4">
      ...
      <p class="text-right" v-if="!contracts.total">合同编号：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
      <p class="text-right" v-else-if="contracts">合同编号：{{contracts.contractNumber}}</p>
      <div class="row">
        ...
        <p v-if="!contracts.total"><strong class="agree-mg">本协议由以下双方于【&nbsp;&nbsp;&nbsp;】年【&nbsp;&nbsp;&nbsp;】月【&nbsp;&nbsp; 】日在中华人民共和国（以下简称“中国”）北京签订。</strong></p>
        <p v-else-if="contracts"><strong class="agree-mg">本协议由以下双方于【{{contracts.year}}】年【{{contracts.month}}】月【{{contracts.day}}】日在中华人民共和国（以下简称“中国”）北京签订。</strong></p>
        <br>
        ...
        <p><strong class="agree-mg">第一条 &nbsp;&nbsp;借款</strong></p>
        ...
        <div class="col-md-10 col-md-offset-2 tbl">
          <table border="1">
            ...
            <tr >
              ...
              <td width="400" align="center" v-if="!contracts.total">人民币（大写）<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;整</u>（小写）RMB<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;元</u><br></td>
              <td width="400" align="center" v-else-if="contracts">人民币（大写）<u>{{contracts.Total}}</u>（小写）RMB<u>{{contracts.total}}元</u><br></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td width="400" align="center" v-if="!contracts.total"><u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u></td>
              <td width="400" align="center" v-else-if="contracts"><u>{{contracts.loanTime}}</u></td>
            </tr>
            <tr>
              <td width="120" align="center">借款最终到期日</td>
              <td width="400" align="center" v-if="!contracts.total"><u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u></td>
              <td width="400" align="center" v-else-if="contracts"><u>{{contracts.repaymentDate}}</u></td>
            </tr>
          </table>
        </div>
        ...
        <br>
        <p><strong class="agree-mg">第二条 &nbsp;&nbsp;出借资金冻结与发放</strong></p>
        ...
        <br>
        <p><strong class="agree-mg">第三条 &nbsp;&nbsp;还款</strong></p>
        ...
        <br>
        <p><strong class="agree-mg">第六条 &nbsp;&nbsp;乙方权利和义务</strong></p>
        ...
        <br>
        <p><strong class="agree-mg">第七条 &nbsp;&nbsp;丙方权利义务</strong></p>
        ...
        <p><strong class="agree-mg">第八条  &nbsp;&nbsp;违约责任</strong></p>
        ...
        <p><strong class="agree-mg">第九条 &nbsp;&nbsp;承诺及保证</strong></p>
        ...
        <br>
        <p><strong class="agree-mg">第十条 &nbsp;&nbsp;通知</strong></p>
        ...
        <br>
        <p><strong class="agree-mg">第十一条 &nbsp;&nbsp;保密条款</strong></p>
        ...
        <br>
        <p><strong class="agree-mg">第十二条 &nbsp;&nbsp;费用承担</strong></p>
        <p class="agree-tx">与本协议有关的公证、登记、评估、鉴定、见证、运输、保管等费用由乙方承担。</p>
        <br>
        <p><strong class="agree-mg">第十三条 &nbsp;&nbsp;不可抗力</strong></p>
        ...
        <br>
        <p><strong class="agree-mg">第十四条 &nbsp;&nbsp;法律适用及争议解决</strong></p>
        ...
        <div v-show="contractType === 1">
          <p><strong class="agree-mg">第十五条 &nbsp;&nbsp;风险提示 </strong></p>
          ...
          <p><strong class="agree-mg">第十六条 &nbsp;&nbsp;其他事项 </strong></p>
        ...
        <div v-show="contractType === 4">
          <p><strong class="agree-mg">第十五条 &nbsp;&nbsp;其他事项 </strong></p>
        ...
        <div v-show="contractType === 1">
          ...
          <p><strong class="agree-mg">甲方：<span v-for="(item, index) in LenderNames" :key="item.index">{{item}}{{LenderNames.length === index + 1 ? '' : '、'}}</span></strong></p>
          <br>
          <br>
          <br>
          <br>
      ...
      <div class="annex1">
        ...
        <table v-if="contracts.total" v-show="contractType === 1">
          ...
          <tbody>
            <tr v-for="(item) in contracts.orderList" :key="item.index">
              <td>{{item.name}}</td>
              <td>{{item.idNo}}</td>
              <td>{{item.amount}}</td>
              <td>{{item.number}}</td>
      ...
      <div class="annex">
        ...
        <table v-if="preRepaymentList.length >0 && isLoan !== 0">
          ...
          <tbody>
            <tr v-for="(item, index) in preRepaymentList" :key="item.index">
              <td>{{index + 1}}</td>
    ...
    <div class="agreement-area row" v-show="contractType === 2">
      <p class="text-title">宏财网服务协议</p>
      <p class="text-right" v-if="!contracts.total">合同编号：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>    
      <p class="text-right" v-else-if="contracts" :key="contract.index">合同编号：{{contracts.contractNumber}}</p>
      <div class="row">
        <p><strong class="agree-mg text-justify">为了维护您的权益，请在签署本协议前，仔细阅读、充分理解本协议各条款（特别是加重、免除或限制协议一方责任条款），关注您在协议中的权利、义务。请您审慎阅读并选择接受或不接受本协议。您一经选择接受即视为对本协议全部条款已充分理解并完全接受。</strong></p>
        <p v-if="!contracts.total"><strong class="agree-mg">本协议由以下双方于【&nbsp;&nbsp;&nbsp;】年【&nbsp;&nbsp;&nbsp;】月【&nbsp;&nbsp; 】日在中华人民共和国（以下简称“中国”）北京签订。</strong></p>
        <p v-else-if="contracts" :key="item.index"><strong class="agree-mg">本协议由以下双方于【{{contracts.year}}】年【{{contracts.month}}】月【{{contracts.day}}】日在中华人民共和国（以下简称“中国”）北京签订。</strong></p>
        <br>
        <p><strong class="agree-mg">协议各方：</strong></p>
        ...
        <p><strong class="agree-mg">第一条 &nbsp;&nbsp;债权转让信息</strong></p>
        <div class="col-md-10 col-md-offset-2 tbl">
          <table border="1">
            <tr >
            ...
            <tr >
              ...
              <td width="400" align="center" v-if="!contracts.total">人民币（大写）<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;整</u>（小写）RMB<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;元</u></td>
    ...
    <div class="agreement-area row" v-show="creditNum === '0' || cutRateType === 5">
      ...
      <p class="text-right" v-if="!cutContracts.contractNumber">合同编号：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
      <p class="text-right" v-else-if="cutContracts">合同编号：{{cutContracts.projectContractNumber}}</p>
      <div class="row">
        <p><strong class="agree-mg text-justify">为了维护您的权益，请在签署本协议前，仔细阅读、充分理解本协议各条款（特别是加重、免除或限制协议一方责任条款），关注您在协议中的权利、义务。请您审慎阅读并选择接受或不接受本协议。您一经选择接受即视为对本协议全部条款已充分理解并完全接受。</strong></p>
        <p v-if="!cutContracts.contractNumber"><strong class="agree-mg">本协议由以下双方于【&nbsp;&nbsp;&nbsp;】年【&nbsp;&nbsp;&nbsp;】月【&nbsp;&nbsp; 】日在中华人民共和国（以下简称“中国”）北京签订。</strong></p>
        <p v-else-if="cutContracts"><strong class="agree-mg">本协议由以下双方于【{{cutContracts.year}}】年【{{cutContracts.month}}】月【{{cutContracts.month}}】日在中华人民共和国（以下简称“中国”）北京签订。</strong></p>
        <br>
        ...
        <p class="agree-tx" v-if="!cutContracts.contractNumber">3、甲、乙双方已经于【&nbsp;&nbsp;&nbsp;】年【&nbsp;&nbsp;&nbsp;】月【&nbsp;&nbsp;&nbsp;】日签订了协议编号为【&nbsp;&nbsp;&nbsp;】《宏财网服务协议》。</p>
        <p class="agree-tx" v-else-if="cutContracts">3、甲、乙双方已经于【{{cutContracts.year}}】年【{{cutContracts.month}}】月【{{cutContracts.month}}】日签订了协议编号为【{{cutContracts.contractNumber}}】《宏财网服务协议》。</p>
        ...
        <p><strong class="agree-mg">第一条 &nbsp;&nbsp;双方的权利和义务</strong></p>
        <p class="agree-tx">1.1 甲方签署本协议，即表示其已经知悉并接受所参与活动的各项条款。</p>
        <p class="agree-tx" v-if="!cutContracts.contractNumber">1.2 甲方明确知悉参与本活动，其在宏财网的协议编号为【&nbsp;&nbsp;&nbsp;】投资，期望年均回报率由【&nbsp;&nbsp;&nbsp;】降为【&nbsp;&nbsp;&nbsp;】，多余部分作为宏财网的服务费，由宏财网在借款人每期还款时自动扣取。</p>
        <p class="agree-tx" v-else-if="cutContracts">1.2 甲方明确知悉参与本活动，其在宏财网的协议编号为【{{cutContracts.contractNumber}}】投资，期望年均回报率由【{{cutContracts.oldRate}}%】降为【{{cutContracts.newRate}}%】，多余部分作为宏财网的服务费，由宏财网在借款人每期还款时自动扣取。</p>
        <p class="agree-tx">1.3 乙方应将活动条款，在其网站或App的相关页面做全面、清晰的展示。</p>
        <p class="agree-tx">1.4 乙方按活动条款及时兑付甲方获得的奖品，具体奖品以乙方最终发放为准。</p>
        <p><strong class="agree-mg">第二条 &nbsp;&nbsp;其他事项</strong></p>

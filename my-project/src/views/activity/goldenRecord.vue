      ...
      <div class="fall-record position-re">
        ...
        <div class="table-wrap">
          <table v-if="showRecord">
            ...
            <tbody>
              <tr v-for="(item, index) in recordList" :key="item.index" v-bind:class="{'border-none': index === recordList.length-1}">
...
<script>
  import GoldenAddress from '../../components/golden-adress.vue'
  export default {
    name: 'goldenRecord',
    data () {
      return {
